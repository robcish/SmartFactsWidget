...
Facts follow [content/FACT_GENERATION_RULES.md](content/FACT_GENERATION_RULES.md):

- **1 fact = 1 slot** (00:00 / 06:00 / 12:00 / 18:00), in **pl-PL** + **en-US**
- **Category cooldown:** same category cannot repeat for **2 calendar days**
- Regenerate schedule: `python3 tools/generate_facts_database.py`
...
**Agent workflow:** add/edit Markdown in `content/`, follow [content/FACT_GENERATION_RULES.md](content/FACT_GENERATION_RULES.md), commit, push to `main`.
